...
- `zepto_analysis.sql` — Complete SQL workflow:
  - table creation
  - cleaning queries
  - exploratory checks
...
2. Create/select your target database.
3. Import/load Zepto CSV data into the `zepto` table.
4. Run `/tmp/workspace/ranjith1444/Zepto-SQL-Data-Analysis-Project/zepto_analysis.sql`.
